...
import codecs
from spider.get_character_array import get_character
import os
#/home/lrq/桌面/文件/知识图谱/KGQA_HLM-master/spider
if not os.path.exists("/home/lrq/桌面/文件/知识图谱/KGQA_HLM-master/spider/images"):
		os.mkdir("/home/lrq/桌面/文件/知识图谱/KGQA_HLM-master/spider/images")
